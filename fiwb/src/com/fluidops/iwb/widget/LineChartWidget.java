...
/**
 * Show the results of a query in form of a line chart. 
 ...
 */
@TypeConfigDoc(
        "The line chart widget represents query result data in the form of a line chart.  There are several types of lines that can be defined including" +
        ", clustered lines, smooted line and custom bullets." )
public class LineChartWidget extends AbstractChartWidget<LineChartWidget.Config>
{
