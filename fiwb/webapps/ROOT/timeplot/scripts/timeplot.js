...
Timeplot._Impl.prototype = {
    ...
    _initialize: function() {
        ...
        if (this._isBrowserSupported(canvas)) {
            ...
            var elmtCopyright = SimileAjax.Graphics.createTranslucentImage(Timeplot.urlPrefix + "timeplot/images/copyright.png");
            ...
            message.contentDiv.innerHTML = "<img src='" + Timeplot.urlPrefix + "timeplot/images/progress-running.gif' /> Loading...";
