    ...
    initialize: function() {
        if (this._dataSource && this._dataSource.getValue) {
            ...
            if (!this._valueFlagLineLeft.firstChild) {
                this._valueFlagLineLeft.appendChild(SimileAjax.Graphics.createTranslucentImage(Timeplot.urlPrefix + "timeplot/images/line_left.png"));
                this._valueFlagLineRight.appendChild(SimileAjax.Graphics.createTranslucentImage(Timeplot.urlPrefix + "timeplot/images/line_right.png"));
            }
