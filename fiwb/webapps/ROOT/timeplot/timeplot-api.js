<%@ page import="com.fluidops.iwb.api.EndpointImpl"%>
/*==================================================
 *  Simile Timeplot API
 *
    ...
    */
    ...
    var loadTimeplot = function() {
        ...
        if (typeof Timeplot_urlPrefix == "string") {
            ...
            var url = "<%= EndpointImpl.api().getRequestMapper().getContextPath()%>/timeplot-api.js";
            if (url == null) {
...
//        }
        ...
        if (Timeplot.params.bundle && !local) {
            scriptURLs.push(timeplotURLPrefix + "timeplot/timeplot-bundle.js");
            cssURLs.push(timeplotURLPrefix + "timeplot/timeplot-bundle.css");
        } else {
            SimileAjax.prefixURLs(scriptURLs, timeplotURLPrefix + "timeplot/scripts/", javascriptFiles);
            SimileAjax.prefixURLs(cssURLs, timeplotURLPrefix + "timeplot/styles/", cssFiles);
        }
    ...
    var loadTimeline = function() {
        if (typeof Timeline != "undefined") {
            ...
            var timelineURL = "<%= EndpointImpl.api().getRequestMapper().getContextPath()%>/timeline_2.3.0/timeline_js/timeline-api.js?bundle=true";
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = "<%= EndpointImpl.api().getRequestMapper().getContextPath()%>/timeline_2.3.0/timeline_ajax/simile-ajax-api.js"
